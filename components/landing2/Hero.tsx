        ...
        <div className="grid items-center gap-12 md:grid-cols-2">
          <div className="max-w-xl">
            ...
            <h1 className="mb-4 text-4xl font-extrabold tracking-tight text-gray-900 md:text-5xl">
              Современная медицинская платформа
            </h1>
            <p className="mb-8 text-base leading-relaxed text-gray-500 md:text-lg">
              Запись к врачу, электронная медицинская карта и лабораторные исследования в одном месте.
            </p>
          ...
          <div className="relative hidden md:block">
            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xl">
              ...
              <div className="mb-4 grid grid-cols-2 gap-3">
                ...
                <div className="rounded-xl border border-gray-50 bg-gray-50/50 p-3">
                  <div className="text-xs text-gray-400">Анализов</div>
              ...
              <div className="rounded-xl border border-gray-100 bg-gray-50/30 p-3">
                <div className="mb-2 flex items-center justify-between">
                  <span className="text-xs font-semibold text-gray-700">Ближайший приём</span>
                  <span className="text-xs text-cyan-600 font-medium">16 окт, 10:00</span>
                </div>
