...
| Первая | 3 → ✅3 | 6 → ✅4 | 8 | 7 |
| Вторая | 0 | 2 → ✅2 | 15 → ✅9 | 2 |
| **Старый остаток** | **0** | **0** | **0** | **2** |

**Топ-5 (осталось):**
1. 🟡 httpx pool в 5 местах → **✅ singleton**
2. 🟡 AuthContext fetch напрямую → **✅ api/client**
3. 🟡 useOrders нет AbortController → **✅ AbortController**
4. 🟡 DoctorPage без polling → **✅ polling 10s**
5. 🟡 Нет тестов → **✅ 33 tests**
