...
export default function EmkPatientCardPage() {
  return (
    <div>
      <h1 className="mb-5 text-h2 font-extrabold text-foreground">Электронная медицинская карта</h1>

      {/* Main Info */}
      <section className="mb-4 rounded-xl border border-border bg-card p-5">
        <h2 className="mb-4 text-h3 font-bold text-foreground">Основная информация</h2>
      ...
      {/* Chronic / Allergies */}
      <section className="mb-4 rounded-xl border border-border bg-card p-5">
        <h2 className="mb-3 text-h3 font-bold text-foreground">Хронические заболевания и аллергии</h2>
      ...
      <section className="mb-4 rounded-xl border border-border bg-card p-5">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-h3 font-bold text-foreground">Последние визиты</h2>
          <Link href="/emk/visits" className="text-label font-medium text-primary hover:underline">Все визиты</Link>
        </div>
      ...
      <section className="rounded-xl border border-border bg-card p-5">
        <h2 className="mb-4 text-h3 font-bold text-foreground">Прикреплённые документы</h2>
