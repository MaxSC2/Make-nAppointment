...
| 4 | **Навыки работы в команде (code review, обсуждения)** | 10 | 5.3-5.4 (code review, 24 проблемы найдено, 10 исправлено), Приложение 3 (роли) | [ОТ СЕБЯ: опиши процесс code review: «Я провёл ревью всего бэкенда, нашёл 24 проблемы, исправил 10. Обсуждали архитектуру PACS-фасада, спорили про Vite proxy и JWT на DICOMweb.»] |
