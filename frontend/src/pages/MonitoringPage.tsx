...
function StatCard({
  ...
  const colorMap: Record<string, string> = {
    ...
    rose: 'bg-rose-50 border-rose-200 text-rose-700 dark:bg-rose-900/30 dark:border-rose-800 dark:text-rose-300',
    teal: 'bg-teal-50 border-teal-200 text-teal-700 dark:bg-teal-900/30 dark:border-teal-800 dark:text-teal-300',
  }
  return (
...
export default function MonitoringPage() {
  ...
  if (error) {
    return (
      <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 rounded-lg p-6">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-5">
        ...
        {byModality.length === 0 ? (
          <div className="text-slate-400 dark:text-slate-500 text-sm">{t('monitoring.noData')}</div>
        ) : (
      ...
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-5">
        ...
        {byCabinet.length === 0 ? (
          <div className="text-slate-400 dark:text-slate-500 text-sm">{t('monitoring.noCabinets')}</div>
        ) : (
          <div className="space-y-3">
            {byCabinet.map(c => (
      ...
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-5">
        ...
        {physicians.length === 0 ? (
          <div className="text-slate-400 dark:text-slate-500 text-sm">{t('monitoring.noActivity')}</div>
        ) : (
