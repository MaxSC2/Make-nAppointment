    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={refetch}
            className="bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-slate-300 px-3 py-1.5 rounded-md text-sm hover:bg-gray-200 dark:hover:bg-slate-600"
          >
            {t('orders.refresh')}
          </button>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-gray-400 dark:text-slate-500">{t('orders.empty')}</div>
      ) : (
