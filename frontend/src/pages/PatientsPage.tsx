  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <input
        ...
        className="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 rounded-lg mb-4 focus:outline-none focus:ring-2 focus:ring-teal-500"
      />
        ...
        <div className="space-y-2">
          {patients.map(p => (
            <button
              ...
              className="w-full text-left bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-4 hover:border-teal-500 hover:shadow-sm transition"
            >
