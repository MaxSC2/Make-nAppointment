      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          <select
            ...
            className="border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 rounded-md px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500"
          >
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
              {studies.map((s) => (
                <tr key={s.orthanc_id} className="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
                  ...
                  <td className="px-4 py-3">
                    {s.unlinked ? (
                      <span className="inline-flex px-2 py-0.5 bg-amber-100 dark:bg-amber-900/30 text-amber-800 dark:text-amber-400 rounded text-xs font-medium">
                        Не связан
                      </span>
                    ) : (
                      <span className="inline-flex px-2 py-0.5 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-400 rounded text-xs font-medium">
                        Связан
                      </span>
                    )}
                  </td>
