  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white border border-slate-200 rounded-lg p-6">
        <h1 className="text-xl font-semibold text-slate-900 mb-1">Назначение исследования</h1>
        <p className="text-sm text-slate-500 mb-6">
          Заполните форму — заказ появится в очереди у рентгенолога
        </p>

        {presetPatient && (
          <div className="mb-4 px-3 py-2 bg-teal-50 border border-teal-200 rounded-md text-sm text-teal-800">
          ...
          <div>
            ...
            {presetPatient ? (
              <input
                ...
                value={patientSearch}
                disabled
                className="w-full px-3 py-2 border border-slate-200 rounded-md bg-slate-50 text-slate-700 text-sm"
              />
            ) : (
              <>
                <input
                ...
                <select
                  ...
                  className="mt-1 w-full px-3 py-1 border border-slate-300 rounded-md text-sm bg-white"
                >
