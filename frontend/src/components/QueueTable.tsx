              ...
              {showActions && (
                <td className="px-4 py-3 text-right space-x-2">
                  <button
                    ...
                    className="text-sm bg-white dark:bg-slate-700 text-teal-600 dark:text-teal-400 border border-teal-300 dark:border-teal-700 px-3 py-1 rounded hover:bg-teal-50 dark:hover:bg-slate-600 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
                  >
                    {t('queue.patientCard')}
                  </button>
