...
export default function Layout() {
  ...
  return (
    <div className={`min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 ${sidebarPinned ? 'lg:ml-60' : ''}`}>
      <Sidebar
        isOpen={sidebarOpen}
      ...
      <main
        ...
        className="flex-1 px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-8 overflow-y-auto"
      >
        <Outlet />
